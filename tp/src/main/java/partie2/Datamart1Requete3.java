...
public class Datamart1Requete3 {
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, Text> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (filename.contains("facturation")) {
                ...
                context.write(idService, new Text(String.valueOf(1)));
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job1 = new Job(conf, "Datamart1Requete3_1");
        job1.setJarByClass(Datamart1Requete3.class);
        ...
        if (job1.waitForCompletion(true)) {
            Job job2 = new Job(conf, "Datamart1Requete3_2");
            job2.setJarByClass(Datamart1Requete3.class);
